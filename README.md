...
Use the executable installer in the [Builds](Builds) folder to install the Orchid package --> [OrchidForDynamo.exe](https://raw.githubusercontent.com/erfajo/OrchidForDynamo/master/Builds/OrchidForDynamo.exe)  
